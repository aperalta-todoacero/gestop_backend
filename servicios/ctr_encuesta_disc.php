     ...
     case 'guardar_encuesta':
      ...
      foreach ($post->respuestas as $r ){
        ...
        $resp['datos']['nombre']=$Usuario->getNombre();
					...
					//$linea = $Usuario->lineaError;
				  $e = ( $error ) ? $error : "Ocurrio un error inesperado mientras resgitrabamos el TEST, si este error continua, sirvase contactar al área de Gestión Personas";
